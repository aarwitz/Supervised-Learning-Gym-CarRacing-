...
directory = "/home/aaron/Documents/School/Exercise 1/"  ######## change that! ########
trained_network_file = os.path.join(directory, 'datatest/train.t7')
imitations_folder = os.path.join(directory, 'datatest/teacher')


def evaluate():
    """
    """
    # infer_action = torch.load(trained_network_file, map_location='gpu')
    ...
    for episode in range(5):
        ...
        for t in range(500):
            ...
            print(f"steer: {steer}, gas: {gas}, brake: {brake}")
...
# train(imitations_folder, trained_network_file)
# evaluate()
# record_imitations(imitations_folder=imitations_folder)